      ...
      <div className="app__navbar-container">
        ...
        >
          ...
          <div className="app__navbar-container_mobilelinks-socials">
            <a href="https://web.facebook.com/abhisek.bhati.9828/" target="blank">
              <img src={Facebook} alt="Facebook" />
            </a>
            <a href="https://www.instagram.com/jatin_bhati03/" target="blank">
              <img src={Instagram} alt="Instagram" />
            </a>
            <a
              href="https://www.linkedin.com/in/jatinbhati/"
              target="blank"
            >
